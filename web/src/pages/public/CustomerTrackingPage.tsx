...
const mockTrackingData: TrackingData = {
  ...
  status: 'InTransit',
  origin: { city: 'Istanbul', address: 'Tuzla Organize Sanayi Bölgesi, No:45', lat: 41.0082, lng: 28.9784 },
  destination: { city: 'Ankara', address: 'Ostim OSB, Çankaya/Ankara', lat: 39.9334, lng: 32.8597 },
