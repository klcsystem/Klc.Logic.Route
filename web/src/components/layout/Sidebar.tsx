...
function CustomerSidebar() {
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      icon: Route,
      items: [
        { to: '/route-optimizer', icon: Zap, label: 'Rota Optimizer' },
    ...
    {
      label: 'ANALİTİK & RAPOR',
      icon: BarChart3,
      items: [
        { to: '/reports', icon: BarChart3, label: 'Raporlar' },
        { to: '/carrier-scorecard', icon: Star, label: 'Taşıyıcı Puanlama' },
    ...
    },
    {
      ...
      icon: Settings,
      items: [
        { to: '/settings', icon: Settings, label: 'Genel Ayarlar' },
        { to: '/settings/routing-profiles', icon: Route, label: 'Rotalama Profilleri' },
        { to: '/settings/depot', icon: MapPin, label: 'Depo Konumu' },
