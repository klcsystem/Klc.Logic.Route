...
VALUES
    ...
    -- Surat (3)
    (d15, tid, p_surat,   'Gokhan Yildiz',       '+905401112233', 'E-34-10015', '2029-03-25', TRUE, NULL,              'SRC2',              10, 'Marmara',               NOW(), FALSE),
    (d16, tid, p_surat,   'Hakan Kilic',         '+905402223344', 'E-06-10016', '2028-11-10', TRUE, NULL,              'SRC2',              10, 'Ic Anadolu',            NOW(), FALSE),
    (d17, tid, p_surat,   'Ilker Sahin',         '+905403334455', 'E-35-10017', '2029-06-20', TRUE, NULL,              'SRC2',              10, 'Ege',                   NOW(), FALSE),
    -- Aras (3)
    (d18, tid, p_aras,    'Kagan Demir',         '+905411112233', 'E-34-10018', '2029-08-15', TRUE, NULL,              'SRC2',              10, 'Marmara,Ic Anadolu',    NOW(), FALSE),
    (d19, tid, p_aras,    'Levent Ozturk',       '+905412223344', 'E-06-10019', '2028-06-20', TRUE, NULL,              'SRC2',              10, 'Ic Anadolu,Karadeniz',  NOW(), FALSE),
...
VALUES
    (gen_random_uuid(), tid, 'Siparis Onayi SMS', 0, 0,
     'Siparisiniz onaylandi',
     'Sayin {{CustomerName}}, {{OrderNumber}} numarali siparisiniz onaylanmistir. Tahmini teslimat: {{ETA}}. Takip: {{TrackingUrl}}',
     'CustomerName,OrderNumber,ETA,TrackingUrl', TRUE, FALSE, NOW(), 'seed'),

    (gen_random_uuid(), tid, 'Yola Cikis Bildirimi', 0, 1,
     'Kargonuz yola cikti',
     'Sayin {{CustomerName}}, {{OrderNumber}} numarali kargonuz surucu {{DriverName}} ile yola cikmistir. Tahmini varis: {{ETA}}. Canli takip: {{TrackingUrl}}',
     'CustomerName,OrderNumber,DriverName,ETA,TrackingUrl', TRUE, FALSE, NOW(), 'seed'),

    (gen_random_uuid(), tid, 'Yaklasma Bildirimi Push', 2, 2,
     'Kargonuz yaklasti',
     'Kargonuz yaklasik {{ETA}} dakika icinde adresinize ulasacaktir. Surucu: {{DriverName}}, Plaka: {{VehiclePlate}}',
     'ETA,DriverName,VehiclePlate', TRUE, FALSE, NOW(), 'seed'),

    (gen_random_uuid(), tid, 'Teslim Edildi Email', 1, 3,
     'Kargonuz teslim edildi',
     'Sayin {{CustomerName}}, {{OrderNumber}} numarali kargonuz basariyla teslim edilmistir. Teslim alan: {{ReceiverName}}. Bizi degerlendirmek icin: {{FeedbackUrl}}',
     'CustomerName,OrderNumber,ReceiverName,FeedbackUrl', TRUE, FALSE, NOW(), 'seed'),

    (gen_random_uuid(), tid, 'Basarisiz Teslimat SMS', 0, 4,
     'Teslimat yapilamadi',
     'Sayin {{CustomerName}}, {{OrderNumber}} numarali kargonuz teslim edilemedi. Sebep: {{FailReason}}. Yeni teslimat randevusu icin: {{RescheduleUrl}}',
...
VALUES
    (opt01, tid, 'Istanbul Dagitim - 2026-06-01',     'Completed', 245.8,  320.0,  4500.00,  3, 12, 'NearestNeighbor', 1250, FALSE, '2026-06-01 08:00:00+03', 'seed'),
    (opt02, tid, 'Ankara Bolge Dagitim - 2026-06-03', 'Completed', 182.3,  250.0,  3200.00,  2,  8, 'NearestNeighbor',  980, FALSE, '2026-06-03 07:30:00+03', 'seed'),
    (opt03, tid, 'Ege Rotasi - 2026-06-05',           'Completed', 310.5,  420.0,  5800.00,  3, 15, 'GeneticAlgorithm', 3500, FALSE, '2026-06-05 06:00:00+03', 'seed'),
    (opt04, tid, 'Marmara Hatti - 2026-06-08',        'Completed', 198.7,  275.0,  3750.00,  2, 10, 'NearestNeighbor',  870, FALSE, '2026-06-08 08:30:00+03', 'seed'),
    (opt05, tid, 'Istanbul-Ankara Express - 2026-06-10','Completed', 450.2, 540.0,  7200.00,  4, 18, 'GeneticAlgorithm', 4200, FALSE, '2026-06-10 05:00:00+03', 'seed'),
    ...
    (opt07, tid, 'Akdeniz Dagitim - 2026-06-15',      'Completed', 275.4,  360.0,  4100.00,  2,  9, 'NearestNeighbor', 1100, FALSE, '2026-06-15 07:00:00+03', 'seed'),
    (opt08, tid, 'Istanbul Sehirici - 2026-06-18',    'Completed', 135.2,  210.0,  2800.00,  3, 16, 'GeneticAlgorithm', 2900, FALSE, '2026-06-18 08:00:00+03', 'seed'),
    (opt09, tid, 'Ic Anadolu Rotasi - 2026-06-20',    'Completed', 380.6,  490.0,  6300.00,  3, 11, 'NearestNeighbor', 1400, FALSE, '2026-06-20 06:00:00+03', 'seed'),
    (opt10, tid, 'Tum Turkiye Haftalik - 2026-06-22', 'Completed', 890.3, 1100.0, 14500.00,  5, 25, 'GeneticAlgorithm', 8500, FALSE, '2026-06-22 05:00:00+03', 'seed')
ON CONFLICT DO NOTHING;
...
VALUES
    -- rt01: Istanbul dagitim (4 stops)
    (gen_random_uuid(), tid, rt01, 1, 'Depot',    'Hadimkoy Lojistik Merkezi, Arnavutkoy',           41.1150, 28.7320, '2026-06-01 08:00+03', '2026-06-01 08:30+03', '2026-06-01 07:00+03', '2026-06-01 09:00+03', 30, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt01, 2, 'Delivery', 'Ikitelli OSB, Basaksehir',                        41.0670, 28.7960, '2026-06-01 09:00+03', '2026-06-01 09:20+03', '2026-06-01 08:00+03', '2026-06-01 12:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt01, 3, 'Delivery', 'Beylikduzu Organize Sanayi',                      41.0050, 28.6280, '2026-06-01 09:50+03', '2026-06-01 10:10+03', '2026-06-01 09:00+03', '2026-06-01 13:00+03', 20, FALSE, NOW(), 'seed'),
    ...
    -- rt02: Istanbul dagitim (4 stops)
    (gen_random_uuid(), tid, rt02, 1, 'Depot',    'Hadimkoy Lojistik Merkezi, Arnavutkoy',           41.1150, 28.7320, '2026-06-01 08:00+03', '2026-06-01 08:30+03', '2026-06-01 07:00+03', '2026-06-01 09:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt02, 3, 'Delivery', 'Dilovasi OSB, Kocaeli',                           40.7830, 29.5430, '2026-06-01 10:15+03', '2026-06-01 10:35+03', '2026-06-01 09:00+03', '2026-06-01 13:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt02, 4, 'Delivery', 'Cayirova Sanayi Bolgesi, Kocaeli',                40.8260, 29.3790, '2026-06-01 11:00+03', '2026-06-01 11:20+03', '2026-06-01 10:00+03', '2026-06-01 14:00+03', 20, FALSE, NOW(), 'seed'),
    -- rt03: Istanbul frigorifik (4 stops)
    (gen_random_uuid(), tid, rt03, 1, 'Pickup',   'Bayramoglu Gida Deposu, Darıca',                  40.7690, 29.3710, '2026-06-01 08:00+03', '2026-06-01 08:40+03', '2026-06-01 07:00+03', '2026-06-01 09:00+03', 40, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt03, 2, 'Delivery', 'Kadikoy Merkez Migros',                           40.9903, 29.0296, '2026-06-01 09:30+03', '2026-06-01 09:50+03', '2026-06-01 09:00+03', '2026-06-01 12:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt03, 3, 'Delivery', 'Uskudar Carsi Market',                            41.0247, 29.0158, '2026-06-01 10:10+03', '2026-06-01 10:30+03', '2026-06-01 09:00+03', '2026-06-01 13:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt03, 4, 'Delivery', 'Maltepe A101 Dagitim',                            40.9356, 29.1290, '2026-06-01 11:00+03', '2026-06-01 11:15+03', '2026-06-01 10:00+03', '2026-06-01 14:00+03', 15, FALSE, NOW(), 'seed'),

    -- rt04: Ankara bolge (4 stops)
    (gen_random_uuid(), tid, rt04, 1, 'Depot',    'Ankara Lojistik Ussü, Sincan',                    39.9680, 32.5730, '2026-06-03 07:30+03', '2026-06-03 08:00+03', '2026-06-03 07:00+03', '2026-06-03 09:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt04, 4, 'Delivery', 'Baskent OSB, Sincan',                             39.9430, 32.5190, '2026-06-03 10:15+03', '2026-06-03 10:35+03', '2026-06-03 09:00+03', '2026-06-03 14:00+03', 20, FALSE, NOW(), 'seed'),
    -- rt05: Ankara bolge (4 stops)
    (gen_random_uuid(), tid, rt05, 1, 'Depot',    'Ankara Lojistik Ussü, Sincan',                    39.9680, 32.5730, '2026-06-03 07:30+03', '2026-06-03 08:00+03', '2026-06-03 07:00+03', '2026-06-03 09:00+03', 30, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt05, 2, 'Delivery', 'Siteler Mobilya Carsisi',                         39.9580, 32.8750, '2026-06-03 08:40+03', '2026-06-03 09:00+03', '2026-06-03 08:00+03', '2026-06-03 12:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt05, 3, 'Delivery', 'Kazan Sanayi Bolgesi',                            40.1680, 32.6810, '2026-06-03 09:45+03', '2026-06-03 10:05+03', '2026-06-03 09:00+03', '2026-06-03 13:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt05, 4, 'Delivery', 'Temelli Sanayi Bolgesi',                          39.8230, 32.3490, '2026-06-03 11:00+03', '2026-06-03 11:25+03', '2026-06-03 10:00+03', '2026-06-03 14:00+03', 25, FALSE, NOW(), 'seed'),

    -- rt06: Ege rotasi (5 stops)
    (gen_random_uuid(), tid, rt06, 1, 'Depot',    'Izmir Ataturk OSB, Cigli',                        38.5010, 27.0560, '2026-06-05 06:00+03', '2026-06-05 06:30+03', '2026-06-05 05:30+03', '2026-06-05 07:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt06, 4, 'Delivery', 'Aydin Merkez Depo',                               37.8560, 27.8416, '2026-06-05 11:15+03', '2026-06-05 11:35+03', '2026-06-05 10:00+03', '2026-06-05 14:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt06, 5, 'Delivery', 'Mugla Lojistik Merkezi',                          37.2153, 28.3636, '2026-06-05 13:00+03', '2026-06-05 13:25+03', '2026-06-05 12:00+03', '2026-06-05 16:00+03', 25, FALSE, NOW(), 'seed'),
    -- rt07: Ege rotasi (5 stops)
    (gen_random_uuid(), tid, rt07, 1, 'Depot',    'Izmir Ataturk OSB, Cigli',                        38.5010, 27.0560, '2026-06-05 06:00+03', '2026-06-05 06:30+03', '2026-06-05 05:30+03', '2026-06-05 07:00+03', 30, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt07, 2, 'Delivery', 'Balikesir OSB',                                   39.6484, 27.8826, '2026-06-05 08:00+03', '2026-06-05 08:25+03', '2026-06-05 07:00+03', '2026-06-05 11:00+03', 25, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt07, 3, 'Delivery', 'Bursa Nilufer OSB',                               40.1885, 29.0610, '2026-06-05 09:45+03', '2026-06-05 10:10+03', '2026-06-05 09:00+03', '2026-06-05 13:00+03', 25, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt07, 4, 'Delivery', 'Eskisehir Organize Sanayi',                       39.7767, 30.5206, '2026-06-05 11:30+03', '2026-06-05 11:55+03', '2026-06-05 10:00+03', '2026-06-05 14:00+03', 25, FALSE, NOW(), 'seed'),
    ...
    -- rt08: Ege (5 stops)
    (gen_random_uuid(), tid, rt08, 1, 'Depot',    'Izmir Ataturk OSB, Cigli',                        38.5010, 27.0560, '2026-06-05 06:00+03', '2026-06-05 06:30+03', '2026-06-05 05:30+03', '2026-06-05 07:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt08, 4, 'Delivery', 'Antalya Serbest Bolge',                           36.8969, 30.7133, '2026-06-05 11:30+03', '2026-06-05 11:55+03', '2026-06-05 10:00+03', '2026-06-05 14:00+03', 25, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt09, 1, 'Depot',    'Cerkezkoy Lojistik Ussu, Tekirdag',               41.2824, 27.5119, '2026-06-08 08:30+03', '2026-06-08 09:00+03', '2026-06-08 08:00+03', '2026-06-08 09:30+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt09, 3, 'Delivery', 'Luleburgaz Sanayi Sitesi',                        41.4040, 27.3550, '2026-06-08 11:10+03', '2026-06-08 11:30+03', '2026-06-08 10:00+03', '2026-06-08 13:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt09, 4, 'Delivery', 'Corlu OSB, Tekirdag',                             41.1580, 27.7960, '2026-06-08 12:15+03', '2026-06-08 12:35+03', '2026-06-08 11:00+03', '2026-06-08 14:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt09, 5, 'Delivery', 'Sakarya OSB, Adapazari',                          40.6940, 30.4358, '2026-06-08 14:30+03', '2026-06-08 14:55+03', '2026-06-08 13:00+03', '2026-06-08 16:00+03', 25, FALSE, NOW(), 'seed'),
    -- rt10: Marmara (5 stops)
    (gen_random_uuid(), tid, rt10, 1, 'Depot',    'Cerkezkoy Lojistik Ussu, Tekirdag',               41.2824, 27.5119, '2026-06-08 08:30+03', '2026-06-08 09:00+03', '2026-06-08 08:00+03', '2026-06-08 09:30+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt10, 3, 'Delivery', 'Duzce OSB',                                       40.8370, 31.1560, '2026-06-08 11:30+03', '2026-06-08 11:50+03', '2026-06-08 10:00+03', '2026-06-08 13:00+03', 20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt10, 4, 'Delivery', 'Yalova Tersaneler Bolgesi',                       40.6500, 29.2700, '2026-06-08 13:00+03', '2026-06-08 13:25+03', '2026-06-08 12:00+03', '2026-06-08 15:00+03', 25, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt10, 5, 'Delivery', 'Bursa Demirtas OSB',                              40.1580, 29.1230, '2026-06-08 14:30+03', '2026-06-08 14:50+03', '2026-06-08 13:00+03', '2026-06-08 16:00+03', 20, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt15, 2, 'Delivery', 'Trabzon Liman Bolgesi',                           41.0015, 39.7178, '2026-06-12 10:00+03', '2026-06-12 10:30+03', '2026-06-12 08:00+03', '2026-06-12 12:00+03', 30, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt15, 3, 'Delivery', 'Rize Caykur Deposu',                              41.0201, 40.5234, '2026-06-12 11:30+03', '2026-06-12 11:50+03', '2026-06-12 10:00+03', '2026-06-12 14:00+03', 20, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt18, 1, 'Depot',    'Mersin Serbest Bolge',                            36.8121, 34.6415, '2026-06-15 07:00+03', '2026-06-15 07:30+03', '2026-06-15 06:30+03', '2026-06-15 08:00+03', 30, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt18, 2, 'Delivery', 'Adana Hacı Sabanci OSB',                          37.0000, 35.3213, '2026-06-15 08:30+03', '2026-06-15 08:55+03', '2026-06-15 08:00+03', '2026-06-15 11:00+03', 25, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt18, 3, 'Delivery', 'Hatay Iskenderun Liman',                          36.4018, 36.3498, '2026-06-15 10:30+03', '2026-06-15 10:55+03', '2026-06-15 09:00+03', '2026-06-15 13:00+03', 25, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt18, 4, 'Delivery', 'Kahramanmaras Sanayi',                            37.5847, 36.9371, '2026-06-15 12:30+03', '2026-06-15 12:55+03', '2026-06-15 11:00+03', '2026-06-15 15:00+03', 25, FALSE, NOW(), 'seed'),
    ...
    -- rt20: Istanbul sehirici (6 stops)
    ...
    (gen_random_uuid(), tid, rt20, 2, 'Delivery', 'Bahcelievler AVM Teslimat',                       41.0010, 28.8540, '2026-06-18 08:45+03', '2026-06-18 09:00+03', '2026-06-18 08:00+03', '2026-06-18 10:00+03', 15, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt20, 3, 'Delivery', 'Bakirkoy Marina',                                 40.9810, 28.8720, '2026-06-18 09:20+03', '2026-06-18 09:35+03', '2026-06-18 09:00+03', '2026-06-18 11:00+03', 15, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt20, 4, 'Delivery', 'Sisli Merkez',                                    41.0600, 28.9870, '2026-06-18 10:00+03', '2026-06-18 10:15+03', '2026-06-18 09:00+03', '2026-06-18 12:00+03', 15, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt20, 5, 'Delivery', 'Levent Is Merkezi',                               41.0810, 29.0130, '2026-06-18 10:35+03', '2026-06-18 10:50+03', '2026-06-18 10:00+03', '2026-06-18 13:00+03', 15, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rt20, 6, 'Delivery', 'Kagithane Sanayi',                                41.0850, 28.9710, '2026-06-18 11:10+03', '2026-06-18 11:30+03', '2026-06-18 10:00+03', '2026-06-18 14:00+03', 20, FALSE, NOW(), 'seed'),

    -- rt23: Ic Anadolu (4 stops)
    (gen_random_uuid(), tid, rt23, 1, 'Depot',    'Ankara Lojistik Ussu, Sincan',                    39.9680, 32.5730, '2026-06-20 06:00+03', '2026-06-20 06:30+03', '2026-06-20 05:30+03', '2026-06-20 07:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt23, 4, 'Delivery', 'Nevsehir Depo',                                   38.6244, 34.7239, '2026-06-20 14:30+03', '2026-06-20 14:55+03', '2026-06-20 13:00+03', '2026-06-20 17:00+03', 25, FALSE, NOW(), 'seed'),

    -- rt24: Ic Anadolu (4 stops)
    (gen_random_uuid(), tid, rt24, 1, 'Depot',    'Ankara Lojistik Ussu, Sincan',                    39.9680, 32.5730, '2026-06-20 06:00+03', '2026-06-20 06:30+03', '2026-06-20 05:30+03', '2026-06-20 07:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt24, 4, 'Delivery', 'Kirikkale Silah Sanayi Bolgesi',                  39.8468, 33.5153, '2026-06-20 13:00+03', '2026-06-20 13:25+03', '2026-06-20 12:00+03', '2026-06-20 15:00+03', 25, FALSE, NOW(), 'seed'),

    -- rt25: Tum Turkiye (5 stops)
    (gen_random_uuid(), tid, rt25, 1, 'Depot',    'Istanbul Hadimkoy Lojistik',                      41.1150, 28.7320, '2026-06-22 05:00+03', '2026-06-22 05:30+03', '2026-06-22 04:30+03', '2026-06-22 06:00+03', 30, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rt25, 3, 'Delivery', 'Konya Buyuksehir OSB',                            37.8746, 32.4932, '2026-06-22 13:00+03', '2026-06-22 13:30+03', '2026-06-22 11:00+03', '2026-06-22 15:00+03', 30, FALSE, NOW(), 'seed'),
...
VALUES
    ...
    -- Reserved slots
    (gen_random_uuid(), tid, '2026-06-28', '09:00', '12:00', 'Ayse Yilmaz',    '+905321112233', '34100', 1, '2026-06-25 10:00+03', NULL, '2026-06-27 10:00+03', FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, '2026-06-29', '09:00', '12:00', 'Mehmet Celik',    '+905323334455', '06100', 1, '2026-06-26 09:00+03', NULL, '2026-06-28 09:00+03', FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, '2026-06-30', '10:00', '13:00', 'Hasan Ozturk',    '+905325556677', '35100', 1, '2026-06-27 08:30+03', NULL, '2026-06-29 08:30+03', FALSE, NOW(), 'seed'),
    -- Confirmed slots
    (gen_random_uuid(), tid, '2026-06-25', '09:00', '12:00', 'Zeynep Sahin',    '+905331112233', '34300', 2, '2026-06-22 10:00+03', '2026-06-23 09:00+03', '2026-06-24 10:00+03', FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, '2026-06-26', '14:00', '18:00', 'Emre Dogan',      '+905334445566', '16100', 2, '2026-06-23 14:00+03', '2026-06-24 13:00+03', '2026-06-25 14:00+03', FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, '2026-06-24', '14:00', '18:00', 'Deniz Aydin',     '+905338889900', '41100', 2, '2026-06-21 14:00+03', '2026-06-22 13:00+03', '2026-06-23 14:00+03', FALSE, NOW(), 'seed'),
    -- Expired slots
    (gen_random_uuid(), tid, '2026-06-20', '09:00', '12:00', 'Serkan Yildiz',   '+905341112233', '34700', 3, '2026-06-17 10:00+03', NULL, '2026-06-19 10:00+03', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, '2026-06-20', '13:00', '17:00', 'Volkan Koc',      '+905342223344', '34800', 3, '2026-06-17 11:00+03', NULL, '2026-06-19 11:00+03', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, '2026-06-21', '09:00', '12:00', 'Yasin Ozkan',     '+905343334455', '06400', 3, '2026-06-18 09:00+03', NULL, '2026-06-20 09:00+03', FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, '2026-06-22', '08:00', '11:00', 'Alper Kilic',     '+905345556677', '35300', 3, '2026-06-19 08:00+03', NULL, '2026-06-21 08:00+03', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, '2026-06-22', '14:00', '18:00', 'Baris Sahin',     '+905346667788', '42100', 3, '2026-06-19 14:00+03', NULL, '2026-06-21 14:00+03', FALSE, NOW(), 'seed'),
...
VALUES
    (gen_random_uuid(), tid, 5, 'Cok hizli ve guvenilir teslimat, tesekkurler!',                     0, '2026-06-01 14:30+03', 'Ayse Yilmaz',     '+905321112233', d01, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Zamaninda geldi, surucu cok kibar davrandı.',                       2, '2026-06-02 11:00+03', 'Fatma Kaya',       '+905322223344', d02, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 3, 'Teslimat biraz gec kaldi ama urun saglam geldi.',                   0, '2026-06-03 16:15+03', 'Mehmet Celik',     '+905323334455', d03, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 5, 'Mukemmel hizmet, her zaman tercihim olacak.',                       0, '2026-06-04 10:45+03', 'Ali Demir',        '+905324445566', d04, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 2, 'Paket hasarli geldi, dikkatli tasinmamis.',                         1, '2026-06-05 13:20+03', 'Hasan Ozturk',     '+905325556677', d05, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Sogutucu zincir bozulmadan teslim edildi, iyi.',                    0, '2026-06-06 09:30+03', 'Zeynep Sahin',     '+905331112233', d07, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 1, 'Yanlis urun teslim edildi, cok memnuniyetsizim.',                   1, '2026-06-07 15:00+03', 'Elif Aksoy',       '+905332223344', d08, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 5, 'Surucu cok yardimci oldu, urunleri yerine yerlestirdi.',            2, '2026-06-08 12:10+03', 'Murat Korkmaz',    '+905333334455', d09, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Zamaninda ve eksiksiz teslimat.',                                   0, '2026-06-09 17:45+03', 'Emre Dogan',       '+905334445566', d10, FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, 5, 'Her sey harika, surucu profesyoneldi.',                             2, '2026-06-11 11:00+03', 'Cem Polat',        '+905336667788', d12, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Urun kalitesi ve teslimat hizi memnun edici.',                      1, '2026-06-12 10:30+03', 'Tolga Kurt',       '+905337778899', d13, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 2, 'Kargo kutusu ezilmis, icindeki urun cizilmis.',                     1, '2026-06-13 16:00+03', 'Deniz Aydin',      '+905338889900', d14, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 5, 'Beklentilerimin uzerinde bir hizmet aldim.',                        0, '2026-06-14 09:15+03', 'Serkan Yildiz',    '+905341112233', d15, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 3, 'Ortalama bir teslimat deneyimi, fena degildi.',                     0, '2026-06-15 13:40+03', 'Volkan Koc',       '+905342223344', d16, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Soguk zincir kurallarina uygun teslimat yapildi.',                  0, '2026-06-16 11:25+03', 'Yasin Ozkan',      '+905343334455', d17, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 1, 'Teslimat yapilmadi, surucu adresi bulamadim dedi.',                 0, '2026-06-17 18:00+03', 'Zafer Aslan',      '+905344445566', d18, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 5, 'Harika deneyim, surucu 10 dakika once aradi.',                      2, '2026-06-18 14:50+03', 'Alper Kilic',      '+905345556677', d19, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Genel olarak iyi, sadece ambalaj biraz zayifti.',                   1, '2026-06-19 10:00+03', 'Baris Sahin',      '+905346667788', d20, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 3, 'Idare eder, surucu pek ilgilenmedi.',                               2, '2026-06-20 15:30+03', 'Cenk Demir',       '+905347778899', d01, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 5, 'En iyi lojistik deneyimim, elinize saglik!',                        0, '2026-06-21 12:15+03', 'Gokhan Yildiz',    '+905401112233', d02, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Hizli teslimat, surucu nazik ve yardimciydi.',                      2, '2026-06-22 09:40+03', 'Hakan Kilic',      '+905402223344', d03, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 2, 'Urun kapisi kapaliydi ama surucu birakmis, riskli.',                0, '2026-06-23 17:10+03', 'Ilker Sahin',      '+905403334455', d04, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 5, 'Tam zamaninda, sorunsuz teslimat. Bravo!',                          0, '2026-06-24 11:50+03', 'Kagan Demir',      '+905411112233', d05, FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 4, 'Paketleme guzel, urun saglam geldi. Tesekkurler.',                  1, '2026-06-25 14:00+03', 'Levent Ozturk',    '+905412223344', d06, FALSE, NOW(), 'seed')
ON CONFLICT DO NOTHING;
...
VALUES
    -- Requested
    (gen_random_uuid(), tid, 'Damaged',   'Requested',       'Kadikoy Moda Caddesi No:15, Istanbul',         40.9903, 29.0296, '2026-06-20 09:00+03', NULL, NULL, 'Urun kutusunda belirgin ezilme var.', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 'WrongItem', 'Requested',       'Cankaya Kavaklidere, Ankara',                  39.9030, 32.8590, '2026-06-21 11:30+03', NULL, NULL, 'Siparis ettigi urun yerine farkli urun gelmis.', FALSE, NOW(), 'seed'),
    -- PickupScheduled
    (gen_random_uuid(), tid, 'Refused',   'PickupScheduled', 'Alsancak Kordon, Izmir',                       38.4350, 27.1420, '2026-06-18 14:00+03', '2026-06-22 10:00+03', NULL, 'Musteri kargo ucretini kabul etmedi.', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 'Damaged',   'PickupScheduled', 'Nilufer Merkez, Bursa',                        40.2080, 28.9770, '2026-06-19 10:00+03', '2026-06-23 09:00+03', NULL, 'Cam urun kirilmis, fotograflar eklendi.', FALSE, NOW(), 'seed'),
    -- InTransit
    (gen_random_uuid(), tid, 'WrongItem', 'InTransit',       'Lara, Antalya',                                36.8580, 30.7350, '2026-06-15 08:30+03', '2026-06-18 10:00+03', NULL, 'Yanlis beden kiyafet gonderilmis.', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 'Other',     'InTransit',       'Seyhan Merkez, Adana',                         37.0000, 35.3213, '2026-06-16 15:00+03', '2026-06-19 14:00+03', NULL, 'Musteri fikir degistirdi, iade istiyor.', FALSE, NOW(), 'seed'),
    -- Received
    (gen_random_uuid(), tid, 'Damaged',   'Received',        'Osmangazi Sanayi, Bursa',                      40.1830, 29.0540, '2026-06-10 09:00+03', '2026-06-13 10:00+03', '2026-06-16 11:00+03', 'Urun depoya ulasti, hasar teyit edildi.', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 'Refused',   'Received',        'Kecioren Merkez, Ankara',                      39.9990, 32.8640, '2026-06-11 10:30+03', '2026-06-14 09:00+03', '2026-06-17 14:00+03', 'Musteri teslimattan hemen sonra iade etti.', FALSE, NOW(), 'seed'),
    -- Processed
    (gen_random_uuid(), tid, 'WrongItem', 'Processed',       'Konak Merkez, Izmir',                          38.4192, 27.1287, '2026-06-05 11:00+03', '2026-06-08 10:00+03', '2026-06-11 09:00+03', 'Dogru urun yeniden gonderildi, iade tamamlandi.', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, 'Other',     'Processed',       'Selcuklu Merkez, Konya',                       37.8746, 32.4932, '2026-06-06 14:00+03', '2026-06-09 14:00+03', '2026-06-12 10:00+03', 'Musteri farkli model istedi, degisim yapildi.', FALSE, NOW(), 'seed')
ON CONFLICT DO NOTHING;
...
SELECT
    ...
    CASE (row_number() OVER (ORDER BY s.created_at)) % 8
        WHEN 0 THEN 41.0082  -- Istanbul
        WHEN 1 THEN 39.9334  -- Ankara
        WHEN 2 THEN 38.4192  -- Izmir
...
SELECT
    ...
    CASE (row_number() OVER (ORDER BY s.created_at)) % 5
        ...
        WHEN 1 THEN 'Kucuk fark tolerans limiti icinde, onaylandi.'
        WHEN 2 THEN 'Fatura tutari beklenen tutardan yuksek, incelenmesi gerekiyor.'
        WHEN 3 THEN 'Henuz inceleme yapilmadi.'
        ELSE 'Fatura tutari sozlesme disinda, reddedildi.'
    END,
...
VALUES
    (rr01, tid, 'Istanbul Gunluk Dagitim',           'Daily',   'Monday,Tuesday,Wednesday,Thursday,Friday', TRUE, opt01, '2026-06-25 06:00+03', 120, FALSE, NOW(), 'seed'),
    (rr02, tid, 'Ankara-Konya Haftalik Sevkiyat',    'Weekly',  'Monday,Thursday',                          TRUE, opt02, '2026-06-23 07:00+03',  48, FALSE, NOW(), 'seed'),
    (rr03, tid, 'Tum Turkiye Aylik Dagitim',         'Monthly', NULL,                                       TRUE, opt10, '2026-06-01 05:00+03',  12, FALSE, NOW(), 'seed')
ON CONFLICT DO NOTHING;

-- rr01: Istanbul gunluk (6 stops)
...
VALUES
    (gen_random_uuid(), tid, rr01, 1, 'Depot',    'Hadimkoy Lojistik Merkezi',           41.1150, 28.7320, '07:00', '08:00', 30, NULL, 'Ana depo yukleme noktasi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr01, 2, 'Delivery', 'Ikitelli OSB, Basaksehir',            41.0670, 28.7960, '08:30', '10:00', 20, 'Vestel Elektronik',        'Sabah erken teslimat', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr01, 3, 'Delivery', 'Beylikduzu OSB',                      41.0050, 28.6280, '10:00', '12:00', 20, 'LC Waikiki Depo',          'Tekstil dagitimi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr01, 4, 'Delivery', 'Tuzla Deri OSB',                      40.8180, 29.3010, '12:00', '14:00', 25, 'Ford Otosan',              'Otomotiv parcasi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr01, 5, 'Delivery', 'Gebze OSB, Kocaeli',                  40.8020, 29.4310, '14:00', '16:00', 25, 'Arcelik Beyaz Esya',       'Beyaz esya dagitimi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr01, 6, 'Delivery', 'Dilovasi OSB, Kocaeli',               40.7830, 29.5430, '16:00', '18:00', 20, 'TOFAS Otomotiv',           'Son teslimat noktasi', FALSE, NOW(), 'seed')
ON CONFLICT DO NOTHING;

-- rr02: Ankara-Konya haftalik (5 stops)
INSERT INTO logistics.recurring_route_stops (id, tenant_id, recurring_route_id, stop_order, stop_type, address, lat, lng, time_window_start, time_window_end, service_time_minutes, customer_name, notes, is_deleted, created_at, created_by)
VALUES
    (gen_random_uuid(), tid, rr02, 1, 'Depot',    'Ankara Sincan Lojistik Ussu',         39.9680, 32.5730, '06:00', '07:00', 30, NULL,                       'Yukleme ve kontrol', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr02, 2, 'Pickup',   'Ostim OSB, Ankara',                   39.9770, 32.7320, '07:30', '09:00', 25, 'Turk Traktor',             'Tarim makinesi parcasi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr02, 3, 'Delivery', 'Aksaray Sanayi Sitesi',               38.3687, 34.0210, '11:00', '13:00', 20, 'Cimsa Cimento',            'Insaat malzemesi', FALSE, NOW(), 'seed'),
    ...
    (gen_random_uuid(), tid, rr02, 5, 'Delivery', 'Konya 2. OSB',                        37.9100, 32.5100, '16:00', '18:00', 25, 'Eti Gida',                 'Gida dagitimi', FALSE, NOW(), 'seed')
ON CONFLICT DO NOTHING;

-- rr03: Tum Turkiye aylik (8 stops)
INSERT INTO logistics.recurring_route_stops (id, tenant_id, recurring_route_id, stop_order, stop_type, address, lat, lng, time_window_start, time_window_end, service_time_minutes, customer_name, notes, is_deleted, created_at, created_by)
VALUES
    (gen_random_uuid(), tid, rr03, 1, 'Depot',    'Istanbul Hadimkoy Ana Depo',          41.1150, 28.7320, '05:00', '06:00', 45, NULL,                       'Aylik buyuk yukleme', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 2, 'Delivery', 'Ankara Sincan OSB',                   39.9680, 32.5730, '10:00', '12:00', 30, 'Teknosa Dagitim',          'Elektronik dagitim', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 3, 'Delivery', 'Izmir Ataturk OSB',                   38.5010, 27.0560, '09:00', '11:00', 30, 'Migros Dagitim',           'Gida dagitimi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 4, 'Delivery', 'Bursa Nilufer OSB',                   40.1885, 29.0610, '12:00', '14:00', 25, 'Defacto Tekstil',          'Tekstil dagitimi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 5, 'Delivery', 'Antalya Serbest Bolge',               36.8969, 30.7133, '14:00', '16:00', 25, 'ABC Gida A.S.',            'Gida dagitimi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 6, 'Delivery', 'Adana Hacı Sabanci OSB',              37.0000, 35.3213, '10:00', '12:00', 25, 'Ulker Biskuvi',            'Gida dagitimi', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 7, 'Delivery', 'Gaziantep OSB',                       37.0662, 37.3833, '13:00', '15:00', 30, 'Banvit Tavuk',             'Soguk zincir teslimat', FALSE, NOW(), 'seed'),
    (gen_random_uuid(), tid, rr03, 8, 'Delivery', 'Samsun Sanayi Sitesi',                41.2928, 36.3313, '08:00', '10:00', 25, 'Eti Gida',                 'Karadeniz bolge dagitimi', FALSE, NOW(), 'seed')
ON CONFLICT DO NOTHING;
